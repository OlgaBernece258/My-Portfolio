import { Box, Container, Grid, Typography, styled, keyframes } from "@mui/material"
...
const handleContactMe = () => {
  window.open(
    'https://www.linkedin.com/in/olga-bernece-pinto-macamo-41458228b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    '_blank'
  )
}
          ...
          <Grid item xs={12} md={8}>
            ...
            <Box mt={3}>
              <Grid container justifyContent="center" spacing={2}>
                ...
                <Grid item xs={12} md="auto">
                  <AnimatedButton onClick={handleContactMe}>
                    <EmailIcon />
